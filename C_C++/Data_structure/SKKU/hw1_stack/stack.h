...
void init_stack(stack_t*, int); //Create stack with user passed size, default size is 10
...
DATA_TYPE peek(stack_t*);		//Return top item of stack. NOTE, do not remove the item.
