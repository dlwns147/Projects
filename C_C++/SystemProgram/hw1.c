...
int main(int argc, char *argv[])
{
	...
	fp_input = fopen("C:/Projects/C_C++_Projects/SystemProgram/input.txt", "r");
	fp_output = fopen("C:/Projects/C_C++_Projects/SystemProgram/output.txt", "w");
	fp_answer = fopen("C:/Projects/C_C++_Projects/SystemProgram/answer.txt", "r");
